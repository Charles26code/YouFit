      ...
      if (formKey.currentState!.validate()) {
        ...
        ScaffoldMessenger.of(context)
          ...
          ..showSnackBar(
            SnackBar(
              content: Text(
                  "Le profile de ${newProfile.firstname} a  ́et ́e ajout ́e !"),
            ),
          );
      }
    } catch (e) {
        ...
        child: Form(
          ...
          child: Column(
            children: [
              TextFormField(
                autofocus: true,
                decoration: const InputDecoration(hintText: 'Pr ́enom'),
                onSaved: (value) => newProfile.firstname = value!,
              ),
              const SizedBox(height: 15),
              TextFormField(
                decoration: const InputDecoration(hintText: 'Nom'),
                onSaved: (value) => newProfile.name = value!,
              ),
              const SizedBox(height: 15),
              Row(
